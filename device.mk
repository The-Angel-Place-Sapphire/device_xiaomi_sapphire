...
# StatiX's hardware/statix/interfaces/health reads this with string branches
# ("true"/"false"), not bool ones, so set it as a string -- soong_config_set_bool
# would declare it bool and fail select() type checking.
