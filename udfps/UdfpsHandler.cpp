...
class XiaomiSm6225UdfpsHandler : public UdfpsHandler {
  public:
    ...
    void onFingerUp() {
        ...
        if (elapsed < 250) {
            // SPANISH: Ignorando falso UP del framework
    ...
    void screenStateMonitorThread() {
        ...
        while (isRunning.load()) {
            ...
            if (brightness != -1) {
                ...
                // SPANISH: Leemos el estado del interruptor de Android
                ...
                if (currentState != lastState) {
                    // SPANISH: Si el interruptor esta apagado, el centinela NO enciende el tactil
